...
export const UserService =
{
    getAllUsersData(): User[] {
        return [
            ...
            { id: 2, name: 'Luana Mandzirosche', createdAt: new Date('2024-04-23'), status: 'Ativo', email: 'luana@smart01.com.br', password: '12', temporaryPassword: true, includeClients: true, editClients: true, deleteClients: false, includeApplication: true, editApplication: true, deleteApplication: false, includeUsers: false, editUsers: true, deleteUsers: false, includeLicenses: false, editLicenses: false, deleteLicenses: false, includeFeatures: false, editFeatures: false, deleteFeatures: false, includePlans: false, editPlans: false, deletePlans: false, includeLogs: false, editLogs: false, deleteLogs: false, confidentialInformation: false },
