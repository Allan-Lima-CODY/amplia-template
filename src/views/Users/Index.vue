...
<template>
  <DefaultLayout>
    ...
    <div v-if="UserService.getUserPermissions().includeUser" class="flex justify-end mt-6">
    ...
    <DataTableMain>
      <DataTable v-model:filters="filters" :value="users" stripedRows paginator @row-edit-init="onEditing"
        ...
        <Column v-if="UserService.getUserPermissions().editUser" header="Editar" :rowEditor="true" style="width: 5%; min-width: 8rem"></Column>
      </DataTable>
    </DataTableMain>
  </DefaultLayout>
</template>